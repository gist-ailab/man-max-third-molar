...
class Bottleneck(BaseModule):
    ...
    def __init__(self,
        ...
        if deform_type is not None and deformable:
            if deform_type == 'dcnv1':
                self.conv2 = DeformableConv2d(**conv_args)
            elif deform_type == 'dcnv2':
                self.conv2 = DeformableConv2dV2(**conv_args)
            elif deform_type == 'cdcnd2':
                self.conv2 = ConstrainedDeformableConv2d2DoF(**conv_args)
            elif deform_type == 'cdcnd3':
                self.conv2 = ConstrainedDeformableConv2d3DoF(**conv_args)
            elif deform_type == 'cdcnd4':
                self.conv2 = ConstrainedDeformableConv2d4DoF(**conv_args)
        else:
            if not self.with_dcn or fallback_on_stride:
                self.conv2 = build_conv_layer(
                    conv_cfg,
...
class ResNet(BaseModule):
    ...
    def __init__(self,
        ...
        self.res_layers = []
        deformable_cfg = [False, True, True, True]
