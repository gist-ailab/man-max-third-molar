...
parser.add_argument('--weight', type=str, default='./weight/maxil_com/PNG+mask/checkpoint_model_ViT_large_r50_s32_384_mask_lr_6e-05_batchsize_8/ViT_large_r50_s32_384_mask_f1_score_0.68261_acc_8638_epoch66.pt') # 0.000009
...
with torch.no_grad():
    ...
    for test_iter, (images, label) in enumerate(test_bar):
        ...
        #     f = open("./maxillary_sinus_label.txt", 'a')
    ...
    plt.savefig("./auroc/up_com_roc.png", dpi=1000)
    ...
    plt.savefig("./auroc/CM_Sinus.png", dpi=1000)
