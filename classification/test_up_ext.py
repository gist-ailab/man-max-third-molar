...
parser.add_argument('--weight', type=str, default='./weight/mandi_com/PNG/checkpoint_model_ViT_large_r50_s32_384_lr_0.0001_batchsize_8/ViT_large_r50_s32_384_f1_score_0.75218_acc_8118_epoch108.pt') # 0.000009
...
with torch.no_grad():
    ...
    plt.savefig("./auroc/up_ext_roc.png", dpi=1000)
    ###############
    ...
    plt.figure()
    class_names = ['VE','STI', 'CBI']
    cnf_matrix = confusion_matrix(y_true, y_pred)
    plot_confusion_matrix(cnf_matrix, classes=class_names,
                      title='Confusion matrix')

    plt.savefig("./auroc/CM_Maxillary_EXT.png", dpi=1000)