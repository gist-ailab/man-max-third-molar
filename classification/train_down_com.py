...
save_dir = "./weight/mandi_com/PNG+mask_final_modi/checkpoint_model_{}_lr_{}_batchsize_{}".format(args.model_name, args.learning_rate, args.batch_size)
#save_dir = "./weight/mandi_com/PNG_segmask/checkpoint_model_{}_lr_{}_batchsize_{}".format(args.model_name, args.learning_rate, args.batch_size)
...
if args.model == 'Vision_Transformer':
    ...
    #model = timm.models.vision_transformer_hybrid.vit_base_r50_s16_224_in21k(pretrained=True, num_classes=3)
    #model = timm.models.vision_transformer_hybrid.vit_large_r50_s32_224_in21k(pretrained=True, num_classes=3)
